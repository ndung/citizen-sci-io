# citizen-sci-io
The *citizen-sci-io* repository hosts a Spring Boot–based platform for citizen‑science data collection. Its Maven configuration establishes the project as “Citisci,” using Java 17 and Spring Boot 3.5.3 with web, security, JPA, and S3 dependencies.
